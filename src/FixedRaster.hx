...
class FixedRaster
{
	...
	function scanline_debug( x0:Reg<Int>, x1:Reg<Int>, y:Reg<Int> )
	{
		...
		OElse,	
			...
			plotPointMul( x0, y, 0x000000FF );
			plotPointMul( x1, y, 0x000000FF );
		__abc__([
		OFi,	
		]);
	}
	...
	function scanPoly( poly:Dynamic )
	{
		...
		*/
		...
		poly.v0 = float_to_fixed( poly.v0 );
		poly.v1 = float_to_fixed( poly.v1 );
		poly.v2 = float_to_fixed( poly.v2 );
